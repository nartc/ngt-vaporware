...
// We can extend the entire THREE namespace for Angular Three catalogue and things like Mesh, MeshBasicMaterial, PlaneGeometry will work out of the box
extend(THREE);

// or we can extend exactly what we need
// extend({
// 	Mesh,
